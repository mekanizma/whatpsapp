...
export const STRONG_CONFIRM_PATTERN =
  /^(evet|onayl?[iıİI]yorum|onaylıyorum|onayliyorum|onay|yes|ja|oui|si|sí|نعم|أؤكد|да|подтверждаю|confirmo|confirme|bestätigen|bestatigen)(?:\s|$|[.!])/iu;

export const WEAK_CONFIRM_PATTERN = /^(tamam|uygun|olur|kabul|ok|okay|d'accord|vale|bien)\s*$/iu;
...
export const PENDING_CONFIRM_PATTERN =
  /onaylıyor musunuz|onayliyor musunuz|randevu özeti|onaylıyor musun|do you confirm|appointment summary|bestätigen sie|confirmez-vous|confirma estos|¿confirma|bestätigen sie diese|confirm these details/i;
