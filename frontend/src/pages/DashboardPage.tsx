  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid gap-4 grid-cols-1 sm:grid-cols-2 xl:grid-cols-3">
        <StatCard title={t('dashboard.totalMessages')} value={stats?.total_messages ?? 0} icon={MessageSquare} color="text-sky-600" bgColor="bg-sky-50" />
        <StatCard title={t('dashboard.todayMessages')} value={stats?.today_messages ?? 0} icon={TrendingUp} color="text-emerald-600" bgColor="bg-emerald-50" />
        <StatCard title={t('dashboard.aiResponses')} value={aiResponses} icon={Bot} color="text-violet-600" bgColor="bg-violet-50" />
        <StatCard title={t('dashboard.transferred')} value={transferred} icon={ArrowRightLeft} color="text-orange-600" bgColor="bg-orange-50" />
        <StatCard title={t('dashboard.activeCustomers')} value={stats?.active_customers ?? 0} icon={Users} color="text-cyan-600" bgColor="bg-cyan-50" />
        <StatCard title={t('dashboard.messageQuota')} value={`${messagesUsed} / ${messagesLimit}`} icon={UserCheck} color="text-primary" bgColor="bg-primary/10" />
      </div>
