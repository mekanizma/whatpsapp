  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid gap-4 grid-cols-1 sm:grid-cols-2 xl:grid-cols-3">
        <StatCard title={t('dashboard.totalMessages')} value={stats?.total_messages ?? 0} icon={MessageSquare} color="text-sky-600" bgColor="bg-sky-50" to="/panel/messages" />
        <StatCard title={t('dashboard.todayMessages')} value={stats?.today_messages ?? 0} icon={TrendingUp} color="text-emerald-600" bgColor="bg-emerald-50" to="/panel/activity/today" />
