...
export function AuthPageLayout({ variant, children }: AuthPageLayoutProps) {
  return (
    <div className="auth-page flex min-h-[100dvh] flex-col lg:h-[100dvh] lg:flex-row lg:overflow-hidden">
      ...
      <div className="flex flex-1 lg:h-full lg:w-1/2 lg:overflow-y-auto lg:overscroll-contain">
        {children}
      </div>
    </div>
  );
