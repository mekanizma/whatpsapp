...
import { Shield, Building2, BarChart3, LogOut, Menu, X, Settings, Zap, Activity, FileText, CreditCard, Receipt } from 'lucide-react';
...
const adminNav = [
  ...
  { to: '/admin/invoice-editor', icon: Receipt, labelKey: 'layout.nav.invoiceEditor' },
...
function resolvePageTitleKey(pathname: string): string {
  ...
  const map: Record<string, string> = {
    ...
    '/admin/invoice-editor': 'layout.nav.invoiceEditor',
